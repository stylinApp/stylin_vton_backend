...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # instance_prompt = 'a photo of ,Men Navy Blue Color Millard Straight Fit Stretchable Cotton Jeans ' +  self.instance_prompt +',properly render the jeans'
        instance_prompt = "a photo of Navy blue woven formal trousers ,Slim fit,Mid-rise,regular length,striped pattern, flat front, with no pleats design ,plain"
