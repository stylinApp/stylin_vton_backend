...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # instance_prompt = 'Generate a high-quality inpainted rendering of, White & Navy Color, Striped Cotton T-shirt using the trained model. Ensure precise reconstruction of facial features and strict containment within specified mask boundaries for optimal results.'
        # instance_prompt = 'a photo of White & Navy Color Striped Cotton T-Shirt.'
        # instance_prompt = "2"
        instance_prompt = "a photo of Colourblocked black and white Round Neck T-shirt"
        # instance_prompt = "a photo of Blue Solid Single-Breasted Blazer"
        # instance_prompt = "a photo of blue solid regular-fit blazer, has a notched lapel, single-breasted, button closures on the front, three pockets, long sleeves, and a double-vented back hem"
        # instance_prompt = "a photo of Floral Printed Casual Cotton Linen white Shirt"
